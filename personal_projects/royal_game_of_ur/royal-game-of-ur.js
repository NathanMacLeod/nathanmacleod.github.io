...
// include: C:\Users\macle\AppData\Local\Temp\tmpyd9t06rs.js
...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "wasm_build/royal-game-of-ur.data";
    var REMOTE_PACKAGE_BASE = "royal-game-of-ur.data";
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_wasm_build/royal-game-of-ur.data");
      }
      Module["addRunDependency"]("datafile_wasm_build/royal-game-of-ur.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/FilePack.dat",
      "start": 0,
      "end": 896550
    } ],
    "remote_package_size": 896550
  });
})();

// end include: C:\Users\macle\AppData\Local\Temp\tmpyd9t06rs.js
var arguments_ = [];
...
function findWasmBinary() {
  return locateFile("royal-game-of-ur.wasm");
}
...
var ASM_CONSTS = {
  ...
  210878: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  210982: () => {
    try {
  ...
  214030: $0 => window.miniaudio.get_device_by_index($0).webaudio.sampleRate,
  214103: $0 => {
  ...
  214876: ($0, $1) => {
    ...
    var olc_ResizeHandler = function() {
      ...
      setTimeout(function() {
        if (Module.olc_AssumeDefaultShells) Module.canvas.parentNode.setAttribute("style", "width: 100%; height: 70vh; margin-left: auto; margin-right: auto;");
