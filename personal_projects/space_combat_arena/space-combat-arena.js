...
// include: C:\Users\macle\AppData\Local\Temp\tmpfhneaudg.js
...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "wasm_build/space-combat-arena.data";
    var REMOTE_PACKAGE_BASE = "space-combat-arena.data";
    ...
    async function runWithFS(Module) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_wasm_build/space-combat-arena.data");
      }
      Module["addRunDependency"]("datafile_wasm_build/space-combat-arena.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/SoundPack.dat",
      "start": 0,
      "end": 7750288
    } ],
    "remote_package_size": 7750288
  });
})();

// end include: C:\Users\macle\AppData\Local\Temp\tmpfhneaudg.js
var arguments_ = [];
...
function findWasmBinary() {
  return locateFile("space-combat-arena.wasm");
}
